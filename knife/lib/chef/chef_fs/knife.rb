...
require "chef/enumerable_parallel_map" unless defined?(Chef::EnumerableParallelMap)

using Chef::EnumerableParallelMap
  ...
  module ChefFS
    class Knife < Chef::Knife
      ...
      def configure_chef
        ...
        Chef::DefaultThreadPool.instance.threads = (Chef::Config[:concurrency] || 10) - 1
      end
